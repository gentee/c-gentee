...
func double rectangle( double x y )
{
   return 2.0 * ( x + y )
}

func double circle( double x )
{
   return 2.0 * 3.1415 * x
}
...
3. Exit\n")
      switch getch()
      {
         case '1' 
         {
            ...
            print("The perimeter of the rectangle: \( rectangle( width, height ))\n\n")
         }
         case '2' 
         {
            print("Specify the radius of the circle: ")
            width = double( conread( input ))
            print("The perimeter of the circle: \( circle( width ))\n\n")
         }
         case '3', 27 : break
