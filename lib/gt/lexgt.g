...
{
   // States
gt_DATA = 0x110000 //  Value of the gt object 
gt_COMMENT = 0x40000 //  Comments 
gt_STRATTR = 0xB0000 //  Value of the attribute 
gt_STRDQ = 0xC0000 //  Value of the attribute in the double quotes 
gt_BEGIN = 0x70000 //  Begin of the gt object 
gt_STRQ = 0xD0000 //  Value of the attribute in the apostrophes 
gt_EQUAL = 0xA0000 //  Equal sign 
gt_NAME = 0x90000 //  Identifier name 
gt_END = 0x1000000 //  End of the gt object 
...
global
{ 
   buf lexgt = '\h4  14 1 FD000000 3C3C 3020094 4 20 2D2D
