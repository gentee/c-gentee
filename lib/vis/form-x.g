...
{  
   this.WinMsg( $WM_SETFONT, GetStockObject( $DEFAULT_GUI_FONT ) )//App.FntM.GetFont("default_big").hFont)//
...
//   Sleep( 2000 )
   ...
   SetActiveWindow( ?( this.Owner.TypeIs( vForm ), this.Owner->vForm.hwnd, activewnd) )
